...
**Lost in Extraction: Native vs. English-Pivot LLM Conflict-Event Coding across Six Languages**
...
Choose the closest available OSF terms in this order:

1. Political Science / International Relations
2. Computer and Information Sciences / Artificial Intelligence
3. Linguistics, Computational Linguistics, Natural Language Processing, or Information Science

Use AI governance as a secondary subject only if OSF provides an exact term. Digital security may be mistaken for cybersecurity, and digital governance is not the main empirical subject of Paper 1.

## Recommended tags

- multilingual conflict-event extraction
...
Code and JSON Schemas: Apache-2.0. Original documentation, codebook, and prompt: CC BY 4.0. No source data are included or licensed.
